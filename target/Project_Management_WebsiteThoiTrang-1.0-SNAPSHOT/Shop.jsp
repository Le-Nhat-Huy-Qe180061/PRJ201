                ...
                <div class="container" style="margin-top:100px">
                    ...
                    <script>
                                                ...
                                                function load(cateid) {
                                                    $.ajax({
                                                        url: "/Project_Management_WebsiteThoiTrang/categoryShop",
                                                ...
                                                function searchByName(param) {
                                                    ...
                                                    $.ajax({
                                                        url: "/Project_Management_WebsiteThoiTrang/searchAjaxShop",
                                                        type: "get", //send it through get method
                                                        data: {
                                                            txt: txtSearch
                                                        },
                                                ...
                                                function searchByPriceMinToMax() {
                                                    ...
                                                    $.ajax({
                                                        url: "/Project_Management_WebsiteThoiTrang/searchAjaxPriceMinToMax",
                                                        type: "get", //send it through get method
                                                        data: {
                                                            priceMin: numMin,
                                                            priceMax: numMax
                                                ...
                                                function searchByPriceUnder100() {
                                                    $.ajax({
                                                        url: "/Project_Management_WebsiteThoiTrang/sortAjaxPriceUnder100",
                                                        type: "get", //send it through get method
                                                        data: {
                                                ...
                                                function searchByPrice100To200() {
                                                    $.ajax({
                                                        url: "/Project_Management_WebsiteThoiTrang/searchAjaxPrice100To200Shop",
                                                        type: "get", //send it through get method
                                                        data: {
                                                ...
                                                function searchByPriceAbove200() {
                                                    $.ajax({
                                                        url: "/Project_Management_WebsiteThoiTrang/searchAjaxPriceAbove200Shop",
                                                        type: "get", //send it through get method
                                                        data: {
