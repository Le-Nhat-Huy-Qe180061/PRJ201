 ...
 * @author ASUS
 */
@WebServlet(name = "SortAjaxPriceUnder100ShopController", urlPatterns = {"/sortAjaxPriceUnder100"})
public class SortAjaxPriceUnder100ShopController extends HttpServlet {
