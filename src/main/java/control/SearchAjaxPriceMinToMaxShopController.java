...
@WebServlet(name = "SearchAjaxPriceMinToMaxShopController", urlPatterns = {"/searchAjaxPriceMinToMax"})
public class SearchAjaxPriceMinToMaxShopController extends HttpServlet {
