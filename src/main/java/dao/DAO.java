...
//    ----------------------- GET PRODUCT  ----------------------- 
    ...
    // Đếm tất cả sản phẩm đã bán bởi ai
    ...
    // Đếm tất cả sản phẩm được bán bởi ai
    ...
    public List<Account> getAllAccount() {
        ...
        String query = "select * from Account order by [uID] DESC";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
...
//            ps.setString(1,ngayXuat);
    ...
    // lấy tất cả sản phẩm có giá trên 200
...
//
    ...
    public List<Product> get4PoloLast() {
        List<Product> list = new ArrayList<>();
        String query = "select top 4 * from Product\r\n"
                + "where cateID = 2\r\n"
                + "order by id desc";
    ...
    public List<Product> get4JEANLast() {
        List<Product> list = new ArrayList<>();
        String query = "select top 4 * from Product\r\n"
                + "where cateID = 1\r\n"
                + "order by id desc";
    ...
    public Account checkAccountExist2(String user) {
    ...
    public void updateAccount(String user, String pass, String isSell, String isAdmin, String email) {
        String query = "UPDATE Account SET pass = ?, isSell = ?, isAdmin = ?, email = ? WHERE [user] = ?";
        try {
            conn = new DBContext().getConnection(); // Mở kết nối với SQL
            ps = conn.prepareStatement(query);
            ps.setString(1, pass);
    ...
    public static void main(String[] args) {
        DAO dao = new DAO();
//        List<Review> list = 
//        	dao.insertProduct("Giày Bóng �?á Nam Bitis Hunter Football","https://product.hstatic.net/1000230642/product/02400vag__1__5d559f914caf4864ad99a37c18cc1a1b_1024x1024.jpg",
//        					"535","Giày Bóng �?á Nam Biti Hunter Football","Với thiết kế năng động, Giày bóng đá Biti’s Hunter được tung ra với 5 màu sắc nổi bật tạo điểm nhấn trên sân đấu.",
...
//      System.out.println("da chay xong");
         ...
         */
//        dao.getAllProduct();
        for (Product x : dao.getAllProduct()) {
