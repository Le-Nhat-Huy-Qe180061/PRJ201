                                        ...
                                        <c:forEach items="${listP}" var="o">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="delete?pid=${o.id}" onclick="return confirmDelete(${o.id})">
                    ...
                    <form action="add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">	
                            ...
                            <div class="form-group">
                                <label>Image 2</label>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="image2" name="image2" accept="image/*" onchange="previewImage(this, 'image2Preview')">
                            ...
                            <div class="form-group">
                                <label>Image 3</label>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="image3" name="image3" accept="image/*" onchange="previewImage(this, 'image3Preview')">
                                    <label class="custom-file-label" for="image2">Choose file</label>
                                </div>
                            ...
                            <div class="form-group">
                                <label>Image 4</label>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="image4" name="image4" accept="image/*" onchange="previewImage(this, 'image4Preview')">
                                    <label class="custom-file-label" for="image2">Choose file</label>
                                </div>
                                <div id="image4Preview" class="mt-2"></div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Model</label>
                                <input name="model" type="text" class="form-control"  oninput="validateAlphabetic(this)">
                            </div>
                            <div class="form-group">
                                <label>Color</label>
                                <input name="color" type="text" class="form-control"  oninput="validateAlphabetic(this)" >
                            </div>
                            <div class="form-group">
                                <label>Delivery</label>
                                <input name="delivery" type="text" class="form-control"  oninput="validateAlphabetic(this)" >
                            </div>
                            <div class="form-group">
