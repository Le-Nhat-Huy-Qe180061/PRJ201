                            ...
                            <div class="card-header py-3 row">
                                ...
                                <div class="col-sm-9 text-right">
                                    <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
                                        <i class="material-icons">&#xE147;</i> Thêm tài khoản
                                    </a>
                                    <form action="xuatExcelAccountControl" method="get" class="d-inline"> 
                            ...
                            <table class="table table-hover text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center">Là người bán hàng</th>
                                        <th scope="col" class="text-center">Là Admin</th>
                                ...
                                <tbody>
                                    <c:forEach items="${listA}" var="o">
                                        <tr>
                                            ...
                                            <td>${o.user}</td>
                                            <td class="text-center">${o.isSell}</td>
                                            <td class="text-center">${o.isAdmin}</td>
                                            <td>${o.email}</td>
                                            <td class="text-center">                                        
                                                <a href="deleteAccount?id=${o.id}" onclick="return confirmDelete(${o.id})">
